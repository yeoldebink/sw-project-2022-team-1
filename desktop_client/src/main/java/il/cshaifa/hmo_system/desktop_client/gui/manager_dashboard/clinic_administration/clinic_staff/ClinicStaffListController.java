...
import il.cshaifa.hmo_system.desktop_client.gui.manager_dashboard.clinic_administration.clinic_appointments.appointment_list.AdminAppointmentListController;
import il.cshaifa.hmo_system.desktop_client.gui.manager_dashboard.clinic_administration.clinic_appointments.appointment_list.AdminAppointmentListViewController;
  ...
  public void clinicStaffListReceived(ClinicStaffEvent event) {
    ...
    for (var clinic_staff_row : event.clinic_staff) {
      ...
      if (!staff_member.getRole().isSpecialist()
          ...
          && row_clinic_manager.getId() != current_clinic_manager.getId()) continue;
