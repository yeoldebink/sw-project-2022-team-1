...
//	}
	...
	public static void main(String[] args) throws IOException {
		if (args.length != 1) {
			...
			il.ac.haifa.client_server.server.src.main.java.il.cshaifa.OCSFHmo.server.HMOServer server = new il.ac.haifa.client_server.server.src.main.java.il.cshaifa.OCSFHmo.server.HMOServer(Integer.parseInt(args[0]));
			server.listen();
		}
	}
}
