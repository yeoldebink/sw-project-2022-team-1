 ...
 * </code> class. Each time a new message is received, observers are notified.
 *
...
public class ObservableClient extends Observable {
  ...
  /**
   * Sets the server port number for the next connection. Only has effect if the client is not
   * currently connected.
   *
  ...
  /**
   * Sets the server host for the next connection. Only has effect if the client is not currently
   * connected.
   *
